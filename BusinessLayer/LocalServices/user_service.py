...
class UserService(metaclass=Singleton):
    @staticmethod
    def create_user(id: str, password: str, favorite_beer_flavor: str, budget: float) -> bool:
        data_user = {'id': id, 'password': password, 'favorite_beer_flavor': favorite_beer_flavor, 'budget': budget}

...
class User(object):
    ...
    def as_dict(self) -> dict:
        data = {"id_user": self.id_user, "email_user": self.email_user, "password_user": self.password_user,
                "favorite_beer_type": self.favorite_beer_type, "budget_user": self.budget_user}
        return data
    
    @staticmethod
    def from_dict(data: dict):
        user = User(data["id_user"], data["email_user"], data["password_user"], data["favorite_beer_type"], data["budget_user"])
        return user
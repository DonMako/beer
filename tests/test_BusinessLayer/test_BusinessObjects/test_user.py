...
class TestUser(TestCase):
    ...
    def test_create_user(self):
        ...
        favorite_beer_type_example = 'bière blonde'
        budget_example = 90.00
        # WHEN
        user = User(id_example, email_example, password_example, favorite_beer_type_example, budget_example)
        # THEN
        ...
        self.assertEqual('bière blonde', user.favorite_beer_type)
    ...
    def test_equal_users(self):
        ...
        user1_favorite_beer_type = 'bière ambrée'
        user1_budget = 2.50
        user2_id = 'tata'
        ...
        user2_budget = 37.64
        # WHEN
        user1 = User(user1_id, user1_email, user1_password, user1_favorite_beer_type, user1_budget)
        user2 = User(user2_id, user2_email, user2_password, user2_favorite_beer_type, user2_budget)
        # THEN

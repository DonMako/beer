...
class TestUser(TestCase):
    ...
    def test_create_user(self):
        # GIVEN
        id_example = 'toto'
        mail_example = 'toto@mail.com'
        password_example = '9520df6412dfdf'
        favorite_beer_flavor_example = 'bière blonde'
        budget_example = 90.00
        # WHEN
        user = User(id_example, mail_example, password_example, favorite_beer_flavor_example, budget_example)
        # THEN
        self.assertIsInstance(user, User)
        self.assertEqual('toto', user.id_user)
        self.assertEqual('toto@mail.com', user.mail_user)
    ...
    def test_equal_users(self):
        # GIVEN
        user1_id = 'toto'
        user1_mail = 'toto@mail.com'
        user1_password = "df54eq65g4zq6ffjzefz"
        user1_favorite_beer_flavor = 'bière ambrée'
        user1_budget = 2.50
        user2_id = 'tata'
        user2_mail = 'tata@mail.com'
        user2_password = "zfhi5557"
        user2_favorite_beer_flavor = 'triple'
        user2_budget = 37.64
        # WHEN
        user1 = User(user1_id, user1_mail, user1_password, user1_favorite_beer_flavor, user1_budget)
        user2 = User(user2_id, user2_mail, user2_password, user2_favorite_beer_flavor, user2_budget)
        # THEN
